...
public class ColorizationActivity extends AppCompatActivity implements CvCameraViewListener2 {
    ...
    public void onCameraViewStarted(int width, int height) {
        ...
        if (!mNetConfigured) {
            Toast showToast = Toast.makeText(ColorizationActivity.this, "Camera is starting...", Toast.LENGTH_LONG);
    ...
    public void configDetectNet() {
        ...
        try {
            if (mCfgbMat.empty()) {
                InputStream cfgIn = getResources().openRawResource(R.raw.colorization_deploy_v2_prototxt);
                mCfgbMat = inputStream2Mat(cfgIn);
            }
            jsonObject.put("cfg", mCfgbMat.getNativeObjAddr());

            if (mModelMat.empty()) {
                InputStream weightsIn = getResources().openRawResource(R.raw.colorization_release_v2_caffemodel);
        ...
        mNativeDetector.callCxx("colorization_configNet", jsonObject.toString());
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item == mItemFace40) {
            ...
            Toast showToast = Toast.makeText(ColorizationActivity.this, "Colorizing...", Toast.LENGTH_LONG);
            showToast.setGravity(Gravity.BOTTOM, 0, 0);
            showToast.show();
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    mNativeDetector.callCxx("colorize", jsonObject.toString());
