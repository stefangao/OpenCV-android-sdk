...
public class ObDetectActivity extends AppCompatActivity implements CvCameraViewListener2 {
    ...
    public void onCameraViewStarted(int width, int height) {
        ...
        if (!mNetConfigured) {
            Toast showToast = Toast.makeText(ObDetectActivity.this, "Camera is starting...", Toast.LENGTH_LONG);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item == mItemFace40) {
            ...
            Toast showToast = Toast.makeText(ObDetectActivity.this, "Detecting object...", Toast.LENGTH_LONG);
            showToast.setGravity(Gravity.BOTTOM, 0, 0);
            showToast.show();
